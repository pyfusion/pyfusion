...
experimental database  and returning pyfusion  data objects. A  set of
base classes and datasystem-specific sub-packages are provided.

There are  two primary  types of classes  involved in  obtaining data.
The   :py:class:`~base.BaseAcquisition`  class   provides   the  basic
interface  to the data  source, setting  up any  connections required.
The :py:class:`~base.BaseDataFetcher` class is used to get data from a
