...
class TestConfigFileSectionNames(BasePyfusionTestCase):
    ...
    def testSectionNames(self):
        ...
        self.assertFalse(self.unlisted_config_section_type in allowed_section_types)
        config.add_section("%s:%s" %(self.unlisted_config_section_type, 'dummy'))
        self.assertRaises(DisallowedSectionType,
                          config.check_section_types,
                          allowed_section_types)
        config.check_section_syntax()
        config.add_section("xxx")
        self.assertRaises(ConfigSectionSyntaxError, config.check_section_syntax)
